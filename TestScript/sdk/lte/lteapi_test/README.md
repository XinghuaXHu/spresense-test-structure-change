# Test Automation Script for lteapi application

## Overview

These python scripts are an implementation for automated testing of __lteapi__ application
...
- To run the test go to __*/autotest/src/tc/lteapi_test/*__ directory and run
  __*lteapi_test_tc_runner.py*__ script. All tests will run automatically.
