# Test Automation Script for mbedtls application

## Overview

These python scripts are an implementation for automated testing of __mbedtls__  application
...
- To run the test go to __*/autotest/src/tc/mbedtls/*__ directory and run
  __*mbedtls_tc_runner.py*__ script. All tests will run automatically.
