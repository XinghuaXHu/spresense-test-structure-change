    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        SDK_Examples_JpegDecode_16614 = Test(
            ...
            test=[
                ...
                Step(Action.WRITE, jpeg_decode16614_test_device, 'md5 -f /mnt/sd0/qvga.YUV'),
                Step(Action.WAIT_FOR, jpeg_decode16614_test_device, 'eeed766be7961819f97b66b402f195ce'),
                ...
                Step(Action.WRITE, jpeg_decode16614_test_device, 'md5 -f /mnt/sd0/orig4.YUV'),
                Step(Action.WAIT_FOR, jpeg_decode16614_test_device, 'c3dfc6f8a192231ff31fb57a11e9ce84'),
            ],
            teardown=teardown
        )

        jpeg_deoode_gp = TestGroup(
            name='jpeg_deoode_gp',
