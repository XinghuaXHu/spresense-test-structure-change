# Test Automation Script for pwm example application

## Overview

These python scripts are an implementation for automated testing of __pwm__ example application
...
- To run the test go to __*/autotest/src/tc/sdk_pwm_example/*__ directory and run
  __*sdk_pwm_example_tc_runner.py*__ script. All tests will run automatically.
