...
from tc.ostest16593_test.ostest_test_device import OsTestTestDevice
...
class OstestTestTcRunner(TestRunner):
    def __init__(self, conf, **kwargs):
        ...
        self.nuttxconfig_path = os.path.join(os.path.dirname(__file__), 'defconfig/16593-config')
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        Nuttx_OsTest_16893_priority_inheritance = Test(
            ...
            test=[
                ...
                Step(Action.WAIT_FOR, ostest_test_device, 'user_main: Exitting'),
            ],
            teardown=teardown
        )
        ...
        ostest = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                Nuttx_OsTest_16893_priority_inheritance,
            ]
        )
