...
from tc.audio_opus_test.player_device import PlayerDevice
from tc.audio_opus_test.recorder_device import RecorderDevice
...
PLAYLIST_FILE = 'input_8k_mono/TRACK_DB.CSV'
AUDIO_FILE = 'input_8k_mono/test.raw'
...
class AudioOpusTestTcRunner(TestRunner):

    def __init__(self, conf, **kwargs):
        super(AudioOpusTestTcRunner, self).__init__(conf)
...
if __name__ == "__main__":
    ...
    if args.input_dirname:
        ...
        AUDIO_FILE = args.input_dirname + '/test.raw'
    ...
    tc_runner = AudioOpusTestTcRunner(config, player=player, recorder=recorder)
