...
from tc.audio_aac_test.player_device import PlayerDevice
from tc.audio_aac_test.recorder_device import RecorderDevice
...
AUDIO_FILE = 'input_24k_stereo/test.aac'
...
class AudioAacTestTcRunner(TestRunner):

    def __init__(self, conf, **kwargs):
        super(AudioAacTestTcRunner, self).__init__(conf)
...
if __name__ == "__main__":
    ...
    if args.input_dirname:
        ...
        AUDIO_FILE = args.input_dirname + '/test.aac'
    ...
    tc_runner = AudioAacTestTcRunner(config, player=player, recorder=recorder)
