...
from tc.audio_player_objif_test.player_device import PlayerDevice
from tc.audio_player_objif_test.recorder_device import RecorderDevice
...
PROJECT = 'spresense'
PLAYER_APPS = ['audio_player_objif', 'zmodem']
RECORDER_APPS = ['audio_recorder_objif', 'zmodem']
PLAYER_APPS_TO_BUILTIN = ['examples/audio_player_objif', 'zmodem']
