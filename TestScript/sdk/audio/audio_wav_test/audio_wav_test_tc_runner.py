...
from tc.audio_wav_test.player_device import PlayerDevice
from tc.audio_wav_test.recorder_device import RecorderDevice
...
global AUDIO_FILE #= 'input_24k_stereo/test.wav'
...
class AudioWavTestTcRunner(TestRunner):

    def __init__(self, conf, **kwargs):
        super(AudioWavTestTcRunner, self).__init__(conf)
...
#        self.flash_n_check(self.recorder, binaries['recorder_bin'], log, RECORDER_APPS_TO_BUILTIN)
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        SDK_Audio_14920 = Test(
            name='SDK_Audio_14920',
...
if __name__ == "__main__":
    ...
    if args.input_dirname:
        ...
        AUDIO_FILE = args.input_dirname + '/test.wav'
    else:
        PLAYLIST_FILE = 'input_24k_stereo/TRACK_DB.CSV'
        AUDIO_FILE = 'input_24k_stereo/test.wav'
    ...
    tc_runner = AudioWavTestTcRunner(config, player=player, recorder=recorder)
