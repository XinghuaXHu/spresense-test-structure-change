...
class RecorderDevice(NuttshellDevice):
    ...
    msg_templates = [
        MessageTemplate(TRANSFERRED_DATA,
                        ('successfully transferred', None, MessageTemplate.validate_line),
                        ),
        MessageTemplate(RECORDER_START,
                        ('Start AudioRecorder', None, MessageTemplate.validate_line),
                        ),
        MessageTemplate(RECORDER_EXIT,
                        ('Exit AudioRecorder', None, MessageTemplate.validate_line),
                        ),
