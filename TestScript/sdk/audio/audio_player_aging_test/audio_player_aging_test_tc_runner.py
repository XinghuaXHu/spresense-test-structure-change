...
from tc.audio_player_aging_test.player_device import PlayerDevice
from tc.audio_player_aging_test.recorder_device import RecorderDevice
...
PLAYLIST_FILE = 'input_48k_stereo/TRACK_DB.CSV'
AUDIO_FILE = 'input_48k_stereo/test.mp3'
...
#                Step(Action.WAIT_FOR, device, 'File {} moved'.format(ENCODER),
        ...
        tc_player_aging_15459 = Test(
            name='tc_player_aging_15459',
