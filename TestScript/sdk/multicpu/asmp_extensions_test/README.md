...
These python scripts are an implementation for automated testing of __asmp_extensions__ application
...
- To run the test go to __*/autotest/src/tc/asmp_extensions_test/*__ directory and run
  __*asmp_extensions_tc_runner.py*__ --flash_bin. All tests will run automatically.
