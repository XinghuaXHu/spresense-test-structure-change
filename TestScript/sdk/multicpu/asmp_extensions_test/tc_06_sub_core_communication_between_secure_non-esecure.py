...
#        device.check_device_config(str(device), APPS_TO_BUILTIN, log)
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        tc_06_sub_core_communication_between_secure_nonesecure = Test(
            name='tc_06_sub_core_communication_between_secure_nonesecure',
            timeout=timeout,
            setup=setup,
            test=[
        ...
        asmp = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                tc_06_sub_core_communication_between_secure_nonesecure,
            ]
        )
