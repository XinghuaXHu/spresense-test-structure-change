...
from tc.ard_subcore16765_test.ard_core_test_device import SpresenseTestDevice
...
def dut_reboot_monitor(test, source, data):
    global value0
    if '[Sub1] Voltage=3.3' in data or '[Sub1] Voltage=3.2' in data:
        value0 += 1
    elif '[Sub1] Voltage=' in data:
...
class ArdMpTestTcRunner(TestRunner):
    ...
    def __init__(self, conf, **kwargs):
        ...
        self.spresense_test_device = SpresenseTestDevice(
            kwargs.get('dut_device', None), 'MP16765_TEST_DEVICE') if kwargs.get('dut_device', None)\
            else None
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        ARD_MP_Example_test_16765 = Test(
            name='ARD_MP_Example_test_16765',
            timeout=timeout,
            setup=setup,
            test=[
