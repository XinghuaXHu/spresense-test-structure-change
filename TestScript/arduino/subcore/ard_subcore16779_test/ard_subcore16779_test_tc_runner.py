...
from tc.ard_subcore16779_test.ard_core_test_device import SpresenseTestDevice
...
class ArdMpTestTcRunner(TestRunner):
    ...
    def __init__(self, conf, **kwargs):
        ...
        self.spresense_test_device = SpresenseTestDevice(
            kwargs.get('dut_device', None), 'MP16779_TEST_DEVICE') if kwargs.get('dut_device', None)\
            else None
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        ARD_MP_Example_test_16779 = Test(
            name='ARD_MP_Example_test_16779',
            timeout=timeout,
            setup=setup,
            test=[
                ...
                Step(Action.WAIT_FOR, spresense_test_device, 'Start Watchdog test'),
                Step(Action.WAIT_FOR, spresense_test_device, '29999 ms left for watchdog bite'),
                Step(Action.WAIT_FOR, spresense_test_device, 'up_assert: Assertion failed at file:irq/irq'),
