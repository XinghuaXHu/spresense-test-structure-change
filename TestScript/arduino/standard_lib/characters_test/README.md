# Test Automation Script for characters example application

## Overview

These python scripts are an implementation for automated testing of __characters__ example application
...
- To run the test go to __*/autotest/src/tc/characters_test/*__ directory and run
  __*characters_test_tc_runner.py*__ script. All tests will run automatically.
