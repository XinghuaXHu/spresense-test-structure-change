# Test Automation Script for adn_eeprom application

## Overview

These python scripts are an implementation for automated testing of __adn_eeprom__  application
...
- To run the test go to __*/autotest/src/tc/adn_eeprom/*__ directory and run
  __*adn_eeprom_tc_runner.py*__ script. All tests will run automatically.
