# Test Automation Script for dig_high_read_low example application

## Overview

These python scripts are an implementation for automated testing of __dig_high_read_low__ example application
...
- To run the test go to __*/autotest/src/tc/dig_high_read_low_test/*__ directory and run
  __*dig_high_read_low_test_tc_runner.py*__ script. All tests will run automatically.
