...
These python scripts are an implementation for automated testing of __dig_read_high__ example application
...
- To run the test go to __*/autotest/src/tc/dig_read_high_test/*__ directory and run
  __*dig_read_high_test_tc_runner.py*__ script. All tests will run automatically.
