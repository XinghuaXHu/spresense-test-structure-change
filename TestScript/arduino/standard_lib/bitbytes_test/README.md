# Test Automation Script for bitbytes example application

## Overview

These python scripts are an implementation for automated testing of __bitbytes__ example application
...
- To run the test go to __*/autotest/src/tc/bitbytes_test/*__ directory and run
  __*bitbytes_test_tc_runner.py*__ script. All tests will run automatically.
