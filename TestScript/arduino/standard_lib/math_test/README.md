# Test Automation Script for math example application

## Overview

These python scripts are an implementation for automated testing of __math__ example application
...
- To run the test go to __*/autotest/src/tc/math_test/*__ directory and run
  __*math_test_tc_runner.py*__ script. All tests will run automatically.
