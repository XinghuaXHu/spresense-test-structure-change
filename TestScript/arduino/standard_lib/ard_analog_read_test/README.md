...
These python scripts are an implementation for automated testing of __ard_analog_read__ example application
...
- To run the test go to __*/autotest/src/tc/ard_analog_read_test/*__ directory and run
