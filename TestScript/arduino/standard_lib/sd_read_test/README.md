# Test Automation Script for sd_read example application

## Overview

These python scripts are an implementation for automated testing of __sd_read__ example application
...
- To run the test go to __*/autotest/src/tc/sd_read_test/*__ directory and run
  __*sd_read_test_tc_runner.py*__ script. All tests will run automatically.
