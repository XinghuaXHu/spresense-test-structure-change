# Test Automation Script for ard_multi_serial example application

## Overview

These python scripts are an implementation for automated testing of __ard_multi_serial__ example application
...
- To run the test go to __*/autotest/src/tc/ard_multi_serial_test/*__ directory and run
  __*ard_multi_serial_test_tc_runner.py*__ script. All tests will run automatically.
