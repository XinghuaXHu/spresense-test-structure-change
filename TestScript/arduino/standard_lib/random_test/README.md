# Test Automation Script for random example application

## Overview

These python scripts are an implementation for automated testing of __random__ example application
...
- To run the test go to __*/autotest/src/tc/random_test/*__ directory and run
  __*random_test_tc_runner.py*__ script. All tests will run automatically.
