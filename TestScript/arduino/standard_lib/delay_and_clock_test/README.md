# Test Automation Script for delay_and_clock example application

## Overview

These python scripts are an implementation for automated testing of __delay_and_clock__ example application
...
- To run the test go to __*/autotest/src/tc/delay_and_clock_test/*__ directory and run
  __*delay_and_clock_test_tc_runner.py*__ script. All tests will run automatically.
