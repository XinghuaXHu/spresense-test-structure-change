...
These python scripts are an implementation for automated testing of __dig_write_low__ example application
...
- To run the test go to __*/autotest/src/tc/dig_write_low_test/*__ directory and run
