# Test Automation Script for adn_analog_write_pwm application

## Overview

These python scripts are an implementation for automated testing of __adn_analog_write_pwm__  application
...
- To run the test go to __*/autotest/src/tc/adn_analog_write_pwm/*__ directory and run
  __*adn_analog_write_pwm_tc_runner.py*__ script. All tests will run automatically.
