...
These python scripts are an implementation for automated testing of __hello__ example application
...
- To run the test go to __*/autotest/src/tc/sd_file_verify_test/*__ directory and run
  __*sd_file_verify_test_tc_runner.py*__ script. All tests will run automatically.
