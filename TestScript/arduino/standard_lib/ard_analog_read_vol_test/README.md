# Test Automation Script for ard_analog_read example application

## Overview

These python scripts are an implementation for automated testing of __ard_analog_read_vol__ example application
...
- To run the test go to __*/autotest/src/tc/ard_analog_read_vol_test/*__ directory and run
  __*ard_analog_read_test_tc_runner.py*__ script. All tests will run automatically.
