# Test Automation Script for trigonometry example application

## Overview

These python scripts are an implementation for automated testing of __trigonometry__ example application
...
- To run the test go to __*/autotest/src/tc/trigonometry_test/*__ directory and run
  __*trigonometry_test_tc_runner.py*__ script. All tests will run automatically.
