...
from tc.gnss16567_arduino_test2.gnss16567_arduino_test_device import Gnss16567TestDevice
...
def reset_count(test, source, data):
    ...
    pos_count = 0
    startTime = datetime.datetime.now()
    endTime = startTime + datetime.timedelta(seconds=50)
    FixTime = startTime
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        SDK_Gnss_16567 = Test(
            ...
            test=[
                ...
                Step(Action.WAIT_FOR, gnss16567_test_device, 'SpGnss : begin out'),
                Step(Action.WAIT_FOR, gnss16567_test_device, 'SpGnss : start in'),
                Step(Action.WAIT_FOR, gnss16567_test_device, 'mode = WARM_START'),
                Step(Action.WAIT_FOR, gnss16567_test_device, 'SpGnss : start out'),
