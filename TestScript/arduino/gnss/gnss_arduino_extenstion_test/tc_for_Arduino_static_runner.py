...
class TestTcRunner(TestRunner):
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        gnssStatic_tc_testing = Test(
            name='gnssStatic_tc_testing',
        ...
        gnssStatic_tc_testing1 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing1.name = 'gnssStatic_tc_testing1'
        gnssStatic_tc_testing2 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing2.name = 'gnssStatic_tc_testing2'
        gnssStatic_tc_testing3 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing3.name = 'gnssStatic_tc_testing3'
        gnssStatic_tc_testing4 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing4.name = 'gnssStatic_tc_testing4'
        gnssStatic_tc_testing5 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing5.name = 'gnssStatic_tc_testing5'
        gnssStatic_tc_testing6 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing6.name = 'gnssStatic_tc_testing6'
        gnssStatic_tc_testing7 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing7.name = 'gnssStatic_tc_testing7'
        gnssStatic_tc_testing8 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing8.name = 'gnssStatic_tc_testing8'
        gnssStatic_tc_testing9 = gnssStatic_tc_testing.clone()
        gnssStatic_tc_testing9.name = 'gnssStatic_tc_testing9'
        ...
        gnss_testing_group = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                gnssStatic_tc_testing,
                gnssStatic_tc_testing1,
                gnssStatic_tc_testing2,
                gnssStatic_tc_testing3,
                gnssStatic_tc_testing4,
                gnssStatic_tc_testing5,
                gnssStatic_tc_testing6,
                gnssStatic_tc_testing7,
                gnssStatic_tc_testing8,
                gnssStatic_tc_testing9,
            ]
        )
