...
from tc.ard_sample_16299_test1.ard_sample_16299_test1_device import MP3TestDevice
...
PROJECT = 'spresense'
APPS_TO_BUILTIN = ['mp3_dec_installer']
...
class ArdMp3TestTcRunner(TestRunner):
    ...
    def __init__(self, conf, **kwargs):
        ...
        self.mp3_test_device = MP3TestDevice(
            kwargs.get('dut_device', None), 'MP3_16299_TEST_DEVICE') if kwargs.get('dut_device', None)\
            else None
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        ARD_Example_test_16299_MP3DEC_sd0 = Test(
            name='ARD_Example_test_16299_MP3DEC_sd0',
            timeout=timeout,
            setup=setup,
            test=[
                Step(Action.WAIT_FOR, mp3_test_device, 'Select where to install MP3DEC'),
                ...
                Step(Action.WAIT_FOR, mp3_test_device, 'Install: /mnt/sd0/BIN/MP3DEC Done.'),
                Step(Action.WAIT_FOR, mp3_test_device, 'Finished.'),
            ],
            teardown=teardown
        )

        ARD_Example_test_16299_MP3DEC_spif = Test(
            name='ARD_Example_test_16299_MP3DEC_spif',
            timeout=timeout,
            setup=setup,
            test=[
                Step(Action.WAIT_FOR, mp3_test_device, 'Select where to install MP3DEC'),
                ...
                Step(Action.WAIT_FOR, mp3_test_device, '2 -> SPI-Flash'),
                Step(Action.WAIT_FOR, mp3_test_device, 'Install: /mnt/spif/BIN/MP3DEC'),
                Step(Action.WAIT_FOR, mp3_test_device, 'Finished.'),
            ],
            teardown=teardown
        )
        ...
        testGroup = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                ARD_Example_test_16299_MP3DEC_sd0,
                ARD_Example_test_16299_MP3DEC_spif,
            ]
        )
