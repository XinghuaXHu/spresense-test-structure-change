...
from tc.ard_mp16787_test.ard_core_test_device import SpresenseTestDevice
...
class ArdMpTestTcRunner(TestRunner):
    ...
    def __init__(self, conf, **kwargs):
        ...
        self.spresense_test_device = SpresenseTestDevice(
            kwargs.get('dut_device', None), 'MP16787_TEST_DEVICE') if kwargs.get('dut_device', None)\
            else None
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        ARD_MP_Example_test_16787 = Test(
            name='ARD_MP_Example_test_16787',
            timeout=timeout,
            setup=setup,
            test=[
                Step(Action.WAIT_FOR, spresense_test_device, 'SharedMemory Address=@'),
                Step(Action.WAIT_FOR, spresense_test_device, 'SharedMemory Check: OK!'),
            ],
            teardown=teardown
        )
