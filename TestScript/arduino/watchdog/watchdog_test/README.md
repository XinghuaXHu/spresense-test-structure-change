# Test Automation Script for watchdog example application

## Overview

These python scripts are an implementation for automated testing of __watchdog__ application
...
- To run the test go to __*/autotest/src/tc/watchdog_test/*__ directory and run
  __*watchdog_test_tc_runner.py*__ script. All tests will run automatically.
