...
from tc.lowpower16363_player_test.lowpower_test_device import LowPowerTestDevice
...
class LowerPowerTestTcRunner(TestRunner):
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        arduino_lowpower_16363_player = Test(
            name='arduino_lowpower_16363_player',
            timeout=timeout,
            setup=setup,
            test=usb_s(player16363_test_device) + \
                ...
                Step(Action.WAIT_FOR, player16363_test_device, 'Open!'),
                Step(Action.WAIT_FOR, player16363_test_device, 'Play!'),
                ...
                Step(Action.WAIT_FOR, player16363_test_device, 'Open!'),
                Step(Action.WAIT_FOR, player16363_test_device, 'Play!'),
                Step(Action.WAIT_FOR, player16363_test_device, 'test end'),
            ],
            teardown=teardown
        )
