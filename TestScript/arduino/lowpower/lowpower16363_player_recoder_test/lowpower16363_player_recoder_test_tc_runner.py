...
from tc.lowpower16363_player_recoder_test.player_device import PlayerDevice
from tc.lowpower16363_player_recoder_test.recorder_device import RecorderDevice
...
def checkStep(test, source, event, log):
    test.log.info(log)
...
class AdnPlayerRecoderTcRunner(TestRunner):
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        lowpower_16363_player = Test(
            name='lowpower_16363_player',
            timeout=timeout,
            setup=setup,
            test=usb_s(recorder_device) + \
                 ...
                 usb_e(player_device) + [
                Step(Action.WAIT_FOR, player_device, 'Please input cmd'),
                Step(Action.WRITE, player_device, '16363', None, '\r'),
                ...
                Step(Action.WRITE, recorder_device, '16363', None, '\r'),
                ...
                Step(Action.WAIT_FOR, recorder_device, 'Boot Cause: (9) RTC Alarm0 expired in cold sleep'),
                Step(Action.WAIT_FOR, player_device, 'Boot Cause: (9) RTC Alarm0 expired in cold sleep'),
        ...
        lowpower_16363_recoder = Test(
            name='lowpower_16363_recoder',
            timeout=timeout,
            setup=setup,
            test=usb_s(recorder_device) + [
                Step(Action.EXECUTE, recorder_device, None,
                     lambda test, source, data: mv_file(test, source, data, '16363.wav',
                                                        os.getcwd() + '/output', '16363.wav')),
                ...
                Step(Action.WAIT_FOR, recorder_device, 'Finish USB Mass Storage Operation',
                     lambda test, source, data: verify_recorded_file(test, source, data, '16363.wav')),
