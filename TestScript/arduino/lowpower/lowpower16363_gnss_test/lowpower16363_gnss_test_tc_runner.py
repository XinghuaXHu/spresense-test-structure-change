...
from tc.lowpower16363_gnss_test.lowpower_test_device import LowPowerTestDevice
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        setup = [
            Step(Action.EXECUTE, gnss16363_test_device, ('dut_reboot_mon', dut_reboot_monitor),
                 Test.add_monitor),
            Step(Action.EXECUTE, gnss16363_test_device, None,
        ...
        arduino_lowpower_16363_gnss = Test(
            name='arduino_lowpower_16363_gnss',
            timeout=timeout,
            setup=setup,
            test=[
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : begin in'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : begin out'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : start in'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'mode = COLD_START'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : start out'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'Gnss setup OK'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'Fix, Lat=35.'),
                ...
                Step(Action.WAIT_FOR, gnss16363_test_device, 'Gnss setup OK'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'Fix, Lat=35.'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : stop in'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : stop out'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : end in'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'SpGnss : end out'),
