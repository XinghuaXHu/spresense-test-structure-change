...
from tc.lowpower16363_number_recognition_test.lowpower_test_device import LowPowerTestDevice
...
class LowerPowerTestTcRunner(TestRunner):
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        arduino_lowpower_16363_number_recognition = Test(
            name='arduino_lowpower_16363_number_recognition',
            timeout=timeout,
            setup=setup,
            test=[
                Step(Action.WAIT_FOR, gnss16363_test_device, 'Image is 4'),
                Step(Action.WAIT_FOR, gnss16363_test_device, 'value 1'),
        ...
        lowpower_16363 = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                arduino_lowpower_16363_number_recognition,
            ]
        )
