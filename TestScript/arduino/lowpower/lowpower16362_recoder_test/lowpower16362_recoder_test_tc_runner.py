...
from tc.lowpower16362_recoder_test.lowpower_test_device import LowPowerTestDevice
...
class LowerPowerTestTcRunner(TestRunner):
    def __init__(self, conf, **kwargs):
        ...
        self.player16362_test_device = LowPowerTestDevice(
    ...
    def get_devices_list(self):
        return [self.player16362_test_device]
    ...
    def setup(self, arguments, log=None):
        ...
        #self.flash_n_check(self.player16362_test_device, binaries['dut_bin'], log)
    ...
    def build(self, debug=True, log=None, **kwargs):
        ...
        if not dut_bin:
            dut_bin = self.__build_binary(toolbox, self.defconfig_path, self.player16362_test_device)
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        arduino_lowpower_16362_recoder = Test(
            name='arduino_lowpower_16362_recoder',
            timeout=timeout,
            setup=setup,
            test=usb_s(player16362_test_device) + \
                ...
                Step(Action.WAIT_FOR, player16362_test_device, 'Init Recorder!'),
                Step(Action.WAIT_FOR, player16362_test_device, 'Recording Start!'),
                ...
                Step(Action.WAIT_FOR, player16362_test_device, 'Init Recorder!'),
                Step(Action.WAIT_FOR, player16362_test_device, 'Recording Start!'),
                Step(Action.WAIT_FOR, player16362_test_device, 'End Recording'),
        ...
        lowpower_16362 = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                arduino_lowpower_16362_recoder,
            ]
        )
