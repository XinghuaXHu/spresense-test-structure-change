# Test Automation Script for bme280 example application

## Overview

These python scripts are an implementation for automated testing of __bme280__ example application
...
- To run the test go to __*/autotest/src/tc/bme280_test/*__ directory and run
  __*bme280_test_tc_runner.py*__ script. All tests will run automatically.
