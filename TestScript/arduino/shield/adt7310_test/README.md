# Test Automation Script for adt7310 example application

## Overview

These python scripts are an implementation for automated testing of __adt7310__ example application
...
- To run the test go to __*/autotest/src/tc/adt7310_test/*__ directory and run
  __*adt7310_test_tc_runner.py*__ script. All tests will run automatically.
