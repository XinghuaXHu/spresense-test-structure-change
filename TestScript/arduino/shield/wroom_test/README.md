# Test Automation Script for wroom example application

## Overview

These python scripts are an implementation for automated testing of __wroom__ example application
...
- To run the test go to __*/autotest/src/tc/wroom_test/*__ directory and run
  __*wroom_test_tc_runner.py*__ script. All tests will run automatically.
