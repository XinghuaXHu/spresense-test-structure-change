...
from tc.adn_player_wav.player_device import PlayerDevice
from tc.adn_player_wav.recorder_device import RecorderDevice
...
DECODERS = ['WAVDEC']
ENCODERS = ['SRC']
AUDIO_FILES = ['15945', '15946', '16259', '16657', '16658', '16659', '16660', '16661', '16662', '16663', '16664', '16665']
...
class AdnPlayerWavTcRunner(TestRunner):

    def __init__(self, conf, **kwargs):
        super(AdnPlayerWavTcRunner, self).__init__(conf)
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        tc_15945 = Test(
            ...
            test=usb_s(recorder_device) + \
                 ...
                 usb_e(player_device) + [
                Step(Action.WAIT_FOR, player_device, 'Please input cmd'),
                Step(Action.WRITE, player_device, '15945'),
                # Step(Action.WAIT_FOR, recorder_device, 'Please input cmd'),
                ...
                Step(Action.EXECUTE, recorder_device, None,
                     lambda test, source, data: mv_file(test, source, data, '15947.wav', os.getcwd() + '/output', '15945.wav')),
                ...
                Step(Action.WAIT_FOR, recorder_device, 'Finish USB Mass Storage Operation',
                     lambda test, source, data: verify_recorded_file(test, source, data, '15945.wav')),
...
if __name__ == "__main__":
    ...
    tc_runner = AdnPlayerWavTcRunner(config, player=player, recorder=recorder)
