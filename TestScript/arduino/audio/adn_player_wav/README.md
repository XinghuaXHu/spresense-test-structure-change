...
These python scripts are an implementation for automated testing of __player_wav__  application
...
- To run the test go to __*/autotest/src/tc/adn_player_wav/*__ directory and run
  __*adn_player_wav_tc_runner.py*__ script. All tests will run automatically.
