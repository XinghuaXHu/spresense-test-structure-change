...
These python scripts are an implementation for automated testing of __recorder_wav__  application
...
- To run the test go to __*/autotest/src/tc/adn_recorder_wav/*__ directory and run
  __*adn_recorder_wav_tc_runner.py*__ script. All tests will run automatically.
