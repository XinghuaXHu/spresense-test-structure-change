...
These python scripts are an implementation for automated testing of __pcm_capture__ example applications
...
- To run the test go to __*/autotest/src/tc/adn_pcm_capture/*__ directory and run
  __*adn_pcm_capture_tc_runner.py*__ script. All tests will run automatically.
