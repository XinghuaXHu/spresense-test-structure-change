# Test Automation Script for adn_tone application

## Overview

These python scripts are an implementation for automated testing of __recorder_wav_objif_test__  application
...
- To run the test go to __*/autotest/src/tc/adn_recorder_wav_objif_test/*__ directory and run
  __*adn_recorder_wav_objif_test_tc_runner.py*__ script. All tests will run automatically.
