...
class AdnPlayerTcRunner(TestRunner):
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        tc_dual_players_16337_15948 = Test(
            name='tc_dual_players_16337_15948',
            timeout=timeout,
            setup=setup,
            test=usb_s(recorder_device) +
                 ...
                 usb_e(player_device) + [
                Step(Action.WAIT_FOR, player_device, 'Please input cmd'),
                Step(Action.WRITE, player_device, '16337'),
                ...
                Step(Action.EXECUTE, recorder_device, None,
                     lambda test, source, data: mv_file(test, source, data, '16648.wav', os.getcwd() + '/output', '16337_output.wav')),
                ...
                Step(Action.WAIT_FOR, recorder_device, 'Finish USB Mass Storage Operation',
                     lambda test, source, data: verify_recorded_file(test, source, data, '16337_output.wav')),
