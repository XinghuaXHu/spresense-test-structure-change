# Test Automation Script for hello example application

## Overview

These python scripts are an implementation for automated testing of __dsp_installer__ example application
...
- To run the test go to __*/autotest/src/tc/dsp_installer_test/*__ directory and run
  __*dsp_installer_test_tc_runner.py*__ script. All tests will run automatically.
