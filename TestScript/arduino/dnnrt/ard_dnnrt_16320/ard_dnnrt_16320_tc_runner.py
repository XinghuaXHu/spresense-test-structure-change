...
from tc.ard_dnnrt_16320.ard_dnnrt_16320_device import SpresenseTestDevice
...
class ArdDNRRT_TestTcRunner(TestRunner):
    ...
    def __init__(self, conf, **kwargs):
        ...
        self.test_device = SpresenseTestDevice(
            kwargs.get('dut_device', None), 'ARD_DNRRT16320_TEST_DEVICE') if kwargs.get('dut_device', None)\
            else None
    ...
    def generate_test_groups(self, arguments, log=None):
        ...
        ARD_DNNRT_Example_test_16320_16321_16322_16323_16272 = Test(
            name='ARD_DNNRT_Example_test_16320_16321_16322_16323_16272',
            timeout=timeout,
            setup=setup,
            test=[
        ...
        testGP = TestGroup(
            ...
            tag=[Tag.POSITIVE],
            tests=[
                ARD_DNNRT_Example_test_16320_16321_16322_16323_16272,
            ]
        )
