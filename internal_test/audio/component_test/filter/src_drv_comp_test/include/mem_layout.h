...
#define L0_SRC_APU_CMD_POOL_L_FENCE  0x000c0004
#define L0_SRC_APU_CMD_POOL_ADDR     0x000c0008
#define L0_SRC_APU_CMD_POOL_SIZE     0x00000398
#define L0_SRC_APU_CMD_POOL_U_FENCE  0x000c03a0
#define L0_SRC_APU_CMD_POOL_NUM_SEG  0x0000000a
