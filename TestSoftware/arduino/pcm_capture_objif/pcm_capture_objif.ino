...
void setup()
{
   ...
   */
  if (strcmp(case_no, "16339") == 0 || strcmp(case_no, "16262") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    ...
                    "/mnt/sd0/BIN");
  else if (strcmp(case_no, "16260") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    AS_CHANNEL_MONO,
                    AS_SAMPLINGRATE_48000,
                    AS_BITLENGTH_16,
                    AS_BITRATE_8000, /* Bitrate is effective only when mp3 recording */
                    "/mnt/sd0/BIN");
  else if (strcmp(case_no, "16261") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    AS_CHANNEL_STEREO,
                    AS_SAMPLINGRATE_48000,
                    AS_BITLENGTH_16,
                    AS_BITRATE_8000, /* Bitrate is effective only when mp3 recording */
                    "/mnt/sd0/BIN");
  else if (strcmp(case_no, "16288") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    AS_CHANNEL_MONO,
                    AS_SAMPLINGRATE_48000,
                    AS_BITLENGTH_24,
                    AS_BITRATE_8000, /* Bitrate is effective only when mp3 recording */
                    "/mnt/sd0/BIN");
  else if (strcmp(case_no, "16289") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    AS_CHANNEL_STEREO,
                    AS_SAMPLINGRATE_48000,
                    AS_BITLENGTH_24,
                    AS_BITRATE_8000, /* Bitrate is effective only when mp3 recording */
                    "/mnt/sd0/BIN");
  else if (strcmp(case_no, "16290") == 0)
    theRecorder->init(AS_CODECTYPE_LPCM,
                    AS_CHANNEL_4CH,
                    AS_SAMPLINGRATE_48000,
                    AS_BITLENGTH_24,
