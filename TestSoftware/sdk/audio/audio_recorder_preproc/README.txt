...
NOTE
  ...
  Set config "SQA_TEST_AUDIO_RECORDER_PREPROC_USEPREPROC" = "y" before do make.

  When SQA_TEST_AUDIO_RECORDER_PREPROC_USEPREPROC is set and build this example,
